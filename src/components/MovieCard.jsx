...
const MovieCard = ({ imdbID, Poster, Title, Type, Year, CTAbuttons }) => {
	return (
		<section className="group py-5 px-2">
			<div className="flex flex-col text-center bg-cardBG rounded-lg shadow-lg shadow-textColor  h-full justify-start items-center relative max-w-md group-hover:scale-105 transition-all duration-500 ease-in-out overflow-hidden w-[160px] sm:min-w-[200px]">
